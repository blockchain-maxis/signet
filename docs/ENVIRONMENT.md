...
| `INDEXER_OPERATIONS_RETENTION_DAYS` | indexer | Optional | `90` | Retention window for indexed `Operation` rows. Records older than this are pruned during periodic maintenance passes. Set to `0` to retain operations indefinitely. |
